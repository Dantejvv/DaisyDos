...
extension TaskManager {
    ...
    ///
    /// See also: `toggleSubtaskCompletion(_:strategy:propagateToParent:)` for advanced use cases
    @discardableResult
    ...
    ///
    /// **Note**: For simple subtask toggling without propagation, use `toggleSubtask(_:)`
